    ...
    render: function () {
        ...
        return (
            <div style={this.componentStyle.placeholder}>
                ...
                <APIFunctionPanel name={APIFactory.UPLOAD_SINGLE_CHUNK.name} description={APIFactory.UPLOAD_SINGLE_CHUNK.description}
                                  parameters={APIFactory.UPLOAD_SINGLE_CHUNK.parameters} headers={defaultHeaders.concat(APIFactory.UPLOAD_SINGLE_CHUNK.headers)}
                />
