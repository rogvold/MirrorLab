...
const XHRHelper = {
    ...
    uploadImage: function(file, onSuccess, onError, onProgress){
        ...
        var uploadUrl = 'http://ecgexpress.sabir.pro/upload.php';
    ...
    uploadFile: function(file, onSuccess, onError, onProgress){
        ...
        var uploadUrl = 'http://ecgexpress.sabir.pro/uploadFile.php';
    ...
    uploadFileAsPromise: function(file){
        var self = this;
        return new Promise(function(resolve, reject){
            self.uploadFile(file, function(uploadedObj){
                resolve(uploadedObj);
            }, function(){
                reject();
            }, ()=>{}, ()=>{});
