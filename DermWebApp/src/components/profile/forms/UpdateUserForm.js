...
class UpdateUserForm extends React.Component {
    ...
    render = () => {
        ...
        let {gender, lastName, firstName, nickname, email, password, jobTitle, about} = this.state;
            ...
            <div className={'update_user_form'} >
                ...
                <div className={'ui form'} >
                    ...
                    <div className={'field'} >
                        ...
                        <input value={jobTitle} placeholder={'О себе'}
                                  onChange={(evt) => {this.setState({jobTitle: evt.target.value, changed: true})}} />
                    </div>

                    <div className={'field'} >
                        <label>О себе</label>
                        <textarea value={about} placeholder={'О себе'}
