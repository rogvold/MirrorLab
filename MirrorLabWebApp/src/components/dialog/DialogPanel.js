...
var DialogPanel = React.createClass({
    ...
    render: function () {
        ...
        var headerPlaceholderStyle = assign({}, this.componentStyle.headerPlaceholder, {zIndex: 100 + 10*this.props.level});
        var closeButtonPlaceholderStyle = assign({}, this.componentStyle.closeButtonPlaceholder, {zIndex: 101 + 10*this.props.level});
